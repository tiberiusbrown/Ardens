...
| Dataset               | Size, MiB | LZAV 5.10 | LZ4 1.9.4 | Snappy 1.1.10 | LZF 3.6 | Source |
|-----------------------|-----------|-----------|-----------|---------------|---------|--------|
